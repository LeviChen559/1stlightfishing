...
const ServiceSlot: FC<IStyle> = ({ height, width }) => {
  ...
  return (
    <Wrapper >
      ...
      <TextContainer>
        <TextBox >
          <H3 style={{textShadow:"5px 5px 5px 5px gray"}} >Service</H3>
        ...
        <TextBox  data-active={true} alignItems="center" justifyContent='flex-end' >
          <BasicButtons text="JOIN US NOW" hrefLink="/en/service"/>
        </TextBox>
      </TextContainer>
      :
      <TextContainer>
      <TextBox >
        <H3 style={{textShadow:"2px 2px gray"}} >專業服務</H3>
        <H5 style={H5_style}>無論您和您的朋友是釣魚新手還是經驗豐富的垂釣者......在 First Light Tackle，我們為每個人提供令人興奮和有益的機會，以進一步發展他們的釣魚技能並最終分享他們對釣魚的共同熱情。</H5>
      </TextBox>
      <TextBox  data-active={true} alignItems="center" justifyContent='flex-end' >
        <BasicButtons text="加入我們" hrefLink="/zh/service"/>
      </TextBox>
    </TextContainer>
    }
